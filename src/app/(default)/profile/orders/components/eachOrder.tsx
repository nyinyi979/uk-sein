    ...
    <>
      {checked && (
        <TableRow>
          ...
          <TableCell>{orderedDate}</TableCell>
          ...
          <TableCell className="ssm:table-cell hidden text-right">{amount.toLocaleString()} MMK</TableCell>
          <TableCell className="md:table-cell hidden">({productCount})</TableCell>
