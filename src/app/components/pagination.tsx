    ...
    <div className="flex flex-row gap-10 ml-auto">
      ...
      <div className="flex flex-row gap-[14px]">
        {activeIndex > 1 && (
          <button
            onClick={() => setIndex(activeIndex - 1)}
            className="py-3 px-[18px] rounded-[10px] bg-white text-grey-500 hover:text-white hover:bg-grey-300 font-semibold duration-300"
          >
            {activeIndex - 1}
          </button>
        )}
        <button className="py-3 px-[18px] rounded-[10px] bg-grey-500 text-white font-semibold duration-300">
          {activeIndex}
        </button>
        ...
        {totalIndex - activeIndex > 2 && (
          <p
            className={`py-3 px-[18px] rounded-[10px] bg-white text-grey-500 font-semibold duration-300`}
          >
            ...
          </p>
        )}
