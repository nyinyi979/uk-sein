  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-0">
        ...
        >
          <div className="w-full xl:h-[450px] h-[240px] relative rounded-[10px]">
            <Image
              src={AboutUs1}
              alt="About us 1"
              fill
        ...
        >
          <div className="w-[full] xl:h-[450px] h-[180px] relative flex flex-row justify-between">
        ...
        >
          <div className="w-[full] xl:h-[450px] h-[150px] relative flex flex-row justify-between">
