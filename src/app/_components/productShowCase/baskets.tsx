...
export default function Baskets() {
  return (
    <MediumCard
      heading="Baskets"
      image={
        <div className="xl:w-[423px] w-[308px] xl:h-[223px] h-[200px] absolute xl:bottom-0 bottom-4 xl:-right-20 -right-32">
          <Image
            src={BasketsImage}
            alt="baskets"
            fill
    ...
    >
      <Link
        href={"/products"}
        className="showcase-button xl:bg-grey-500 xl:text-white text-khaki-500 xl:text-sm text-lg xl:hover:bg-grey-400"
      >
        EXPLORE NOW
        <svg
