    ...
    <div className="xl:w-[550px] w-[500px] flex flex-row gap-[16px] py-[28px] px-[18px] border-b border-dotted border-grey-50">
      ...
      <div className="flex flex-col gap-[18px]">
        <div className="flex flex-col gap-1.5">
          <p className="font-sora font-semibold text-lg">{engName}</p>
          <div className="flex flex-row gap-1.5 font-semibold text-xs">
...
function ItemButtons({
  ...
  return (
    <div className="flex flex-row gap-2.5">
      ...
      <div className="w-[100px] h-10 p-2.5 font-semibold text-center text-xl">
        {quantity}
      </div>
      <button
