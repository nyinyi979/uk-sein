    ...
    <div className="xl:w-fit w-[165px] flex flex-col xl:gap-[26px] md:gap-8 gap-[14px]">
      <div className="flex flex-col gap-[18px]">
        ...
        <div className="flex flex-row flex-wrap gap-6">
          <button className="footer-link" onClick={() => openInNewTab('https://www.facebook.com/ukseinmmlocalcrafts?mibextid=LQQJ4d')}>
            <svg
              width="10"
              height="18"
              viewBox="0 0 10 18"
          ...
          <button className="footer-link" onClick={() => openInNewTab('https://www.facebook.com/ukseinfurniture?mibextid=LQQJ4d')}>
            <svg
              width="10"
              height="18"
              viewBox="0 0 10 18"
          ...
          <button className="footer-link" onClick={() => openInNewTab('https://www.instagram.com/uk_sein_local_crafts?igsh=MXVnbDBsdnc3eWQweA==')}>
            <svg
              width="19"
              height="18"
              viewBox="0 0 19 18"
          ...
          <button className="footer-link" onClick={() => openInNewTab('https://www.tiktok.com/@uksein44?_t=8r6tQDDwveU&_r=1')}>
